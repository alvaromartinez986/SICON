...
urlpatterns = patterns('',
    ...
    url(r'^vehiculos_nuevos/listarvn',listar_vehiculos_nuevos),
    ...
    url(r'^vehiculos_usados/listarvu',listar_vehiculos_usados),
    url(r'^vehiculos_usados/eliminarvu/(\d+)$',eliminar_vehiculo_usado),

	url(r'^sucursales/listar',listar_sucursales),
