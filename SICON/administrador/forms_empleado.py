...
class EmpleadoForm(ModelForm):
    class Meta:
        ...
        widgets={
            ...
            'fecha_vinculacion' = forms.TextInput(attrs={'class':'form-control ','placeholder':'fecha_vinculacion'})
            ...
            'fecha_nacimiento'= forms.TextInput(attrs={'class':'form-control ','placeholder':'fecha_nacimiento'})
